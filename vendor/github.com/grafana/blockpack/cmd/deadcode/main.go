...
func anchorCubeCompactor() {
	...
	// Anchor new public cube_ingest.go + vcnt.go surface.
	_ = blockpack.NewCubeAccumulator(blockpack.CubeDefinition{}, 0)
	_ = blockpack.NewCubeNumericFilter("", blockpack.CubeFilterOpGreater, 0)
	var _ blockpack.CubeSpanValues
	var _ blockpack.CubeObjectPutter
	var _ blockpack.CubeColumnFilter
	var _ blockpack.CubeObjectStore
	_ = blockpack.CubeErrConflict
	_ = blockpack.NewCubeRegistry(nil, "")
	_, _ = blockpack.LoadCubeDefinitions(context.Background(), nil, nil)
	_, _ = blockpack.CubeRegistryEntryToDefinition(blockpack.CubeRegistryEntry{}, nil)
	var _ blockpack.CubeAccumulator
	// cube compactor surface
	_, _ = blockpack.CubeIDFromHex("")
	_, _, _, _ = blockpack.CubeReadHeader(nil)
	_ = blockpack.CubeHeaderSize
	_ = blockpack.NewCubeCompactor(nil, nil, blockpack.CubeCompactorConfig{})
	_ = blockpack.PlanCubeL0Merge(nil, 0, "", "")
	_, _ = blockpack.PlanCubeL1Rollup(nil, 0, "", "")
	var _ blockpack.CubeFileInfo
	var _ blockpack.CubeFileStore
	var _ blockpack.CubeCompactionPlan
	// cube backfill surface
	_ = blockpack.NewCubeBackfiller(blockpack.CubeRegistryEntry{}, nil, blockpack.CubeBackfillConfig{})
	var _ blockpack.CubeValueIndexSource
	var _ blockpack.CubeBackfillProgress
	var _ blockpack.CubeBackfillWatermark
	// cube query/trigger surface
	_, _ = blockpack.OpenCubeReaderFromBytes(nil)
	var _ blockpack.CubeRollupInput
	_ = blockpack.CubeNewRollupInput(nil)
	_, _ = blockpack.CubeRollup(nil, 0, 0, 0)
	var _ blockpack.CubeMergedCell
	var _ blockpack.CubeRoutingResult
	_ = blockpack.NewCubeQueryRouter(nil)
	var _ blockpack.CubeCreationTrigger
	_ = blockpack.NewCubeCreationTrigger(nil, blockpack.CubeTriggerConfig{})
	var _ blockpack.CubeTriggerResult
	var _ blockpack.CubeErrLimitReached
	// vcnt + vi public surface
	_, _ = blockpack.VIParseFilenameV2("")
	var _ blockpack.VIFileMeta
	var _ blockpack.VIQueryResult
	_, _ = blockpack.VIOpenReader(nil)
	blockpack.SortVCNTRecords(nil)
	_, _ = blockpack.EncodeVCNTRecords(nil, 0)
	_ = blockpack.VCNTColHash("")
	_ = blockpack.VCNTFormatFilename(0, "")
	_ = blockpack.VCNTNewID()
	_ = blockpack.VCNTObjectKey("", "", "", "")
}
