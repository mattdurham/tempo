...
// NOTE-LINT-407: constants for repeated literals in the synthetic-data tables (goconst).
const (
	svcRedis           = "redis"
	opGET              = "GET"
	opDEL              = "DEL"
...
var services = []string{
	...
	svcRedis, "valkey", // Dedicated cache services
}
...
// redisOps is the operation set used for synthetic redis/valkey spans.
var redisOps = []string{opGET, "SET", opDEL, "HGET", "HSET"}
	...
	for i := 0; i < numSpans; i++ {
		...
		case 0, 1: // 20% HTTP GET requests (success)
			...
			attributes = []*commonv1.KeyValue{
				{
					Key:   attrHTTPMethod,
					Value: &commonv1.AnyValue{Value: &commonv1.AnyValue_StringValue{StringValue: opGET}},
				},
				{Key: attrHTTPStatusCode, Value: &commonv1.AnyValue{Value: &commonv1.AnyValue_IntValue{IntValue: 200}}},
				{
					Key:   attrHTTPURL,
		...
		case 2: // 10% HTTP POST requests
			...
			attributes = []*commonv1.KeyValue{
				...
				{Key: attrHTTPStatusCode, Value: &commonv1.AnyValue{Value: &commonv1.AnyValue_IntValue{IntValue: 201}}},
				{
					Key:   attrHTTPURL,
					Value: &commonv1.AnyValue{Value: &commonv1.AnyValue_StringValue{StringValue: "/api/v1/" + service}},
				},
		...
		case 4: // 10% HTTP errors (500)
			...
			attributes = []*commonv1.KeyValue{
				...
				{Key: attrHTTPStatusCode, Value: &commonv1.AnyValue{Value: &commonv1.AnyValue_IntValue{IntValue: 500}}},
				{
					Key:   attrHTTPURL,
					Value: &commonv1.AnyValue{Value: &commonv1.AnyValue_StringValue{StringValue: "/api/v1/" + service}},
				},
		...
		case 5: // 10% HTTP errors (404)
			...
			attributes = []*commonv1.KeyValue{
				...
				{Key: attrHTTPStatusCode, Value: &commonv1.AnyValue{Value: &commonv1.AnyValue_IntValue{IntValue: 404}}},
				{
					Key:   attrHTTPURL,
		...
		case 8: // 10% Redis operations
			kind = tracev1.Span_SPAN_KIND_CLIENT
			statusCode = tracev1.Status_STATUS_CODE_OK
			redisOp := redisOps[i%5]
			attributes = []*commonv1.KeyValue{
				{
					Key:   "db.system",
					Value: &commonv1.AnyValue{Value: &commonv1.AnyValue_StringValue{StringValue: svcRedis}},
				},
				{
					Key:   "db.operation",
