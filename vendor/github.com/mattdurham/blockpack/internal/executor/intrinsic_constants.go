...
const (
	...
	IntrinsicSpanTraceState    = "span:trace_state"
...
// Query execution stage names
const (
	StageRoot      = "root"
	StageScanning  = "scanning"
	StagePassed    = "passed"
	StageTimeRange = "time_range"
)

// Block pruning strategy names
const (
	StrategyColumnBloom                = "column_bloom"
	StrategyColumnBloomAndValueFilters = "column_bloom_and_value_filters"
	StrategyDedicatedIndex             = "dedicated_index"
)
