...
func (cs *ColumnScanner) streamScanStringColumn(col *blockpack.Column, target any, matchedRows map[int]bool, count *int, callback vm.RowCallback) error {
...
func (cs *ColumnScanner) streamScanInt64Column(col *blockpack.Column, columnName string, target any, matchedRows map[int]bool, count *int, callback vm.RowCallback) error {
...
func (cs *ColumnScanner) streamScanUint64Column(col *blockpack.Column, columnName string, target any, matchedRows map[int]bool, count *int, callback vm.RowCallback) error {
...
func (cs *ColumnScanner) streamScanBoolColumn(col *blockpack.Column, columnName string, target any, matchedRows map[int]bool, count *int, callback vm.RowCallback) error {
...
func (cs *ColumnScanner) streamScanFloat64Column(col *blockpack.Column, columnName string, target any, matchedRows map[int]bool, count *int, callback vm.RowCallback) error {
...
func (cs *ColumnScanner) streamScanBytesColumn(col *blockpack.Column, columnName string, target any, matchedRows map[int]bool, count *int, callback vm.RowCallback) error {
...
func (cs *ColumnScanner) streamScanSingleColumnEqual(col *blockpack.Column, columnName string, target any, matchedRows map[int]bool, count *int, callback vm.RowCallback) error {
	switch col.Type {
...
func (cs *ColumnScanner) streamScanStringNotEqual(col *blockpack.Column, target any, callback vm.RowCallback) (int, error) {
	count := 0
...
func (cs *ColumnScanner) streamScanInt64NotEqual(col *blockpack.Column, target any, callback vm.RowCallback) (int, error) {
	targetInt, ok := toInt64(target)
	if !ok {
...
func (cs *ColumnScanner) streamScanUint64NotEqual(col *blockpack.Column, target any, callback vm.RowCallback) (int, error) {
	targetUint, ok := toUint64(target)
	if !ok {
...
func (cs *ColumnScanner) streamScanBoolNotEqual(col *blockpack.Column, target any, callback vm.RowCallback) (int, error) {
	targetBool, ok := target.(bool)
	if !ok {
...
func (cs *ColumnScanner) streamScanFloat64NotEqual(col *blockpack.Column, target any, callback vm.RowCallback) (int, error) {
	targetFloat, ok := toFloat64(target)
	if !ok {
...
func (cs *ColumnScanner) streamScanBytesNotEqual(col *blockpack.Column, target any, callback vm.RowCallback) (int, error) {
	targetBytes, ok := toBytesOrString(target)
	if !ok {
...
func (cs *ColumnScanner) streamScanStringLessThan(col *blockpack.Column, target any, callback vm.RowCallback) (int, error) {
	// Handle numeric target (string to number comparison)
	if targetNumeric, ok := numericTarget(target); ok {
		count := 0
		for i := 0; i < cs.block.SpanCount(); i++ {
...
func (cs *ColumnScanner) streamScanInt64LessThan(col *blockpack.Column, target any, callback vm.RowCallback) (int, error) {
	targetInt, ok := toInt64(target)
	if !ok {
		return 0, fmt.Errorf("type mismatch: expected int64 for column")
	}
...
func (cs *ColumnScanner) streamScanUint64LessThan(col *blockpack.Column, target any, callback vm.RowCallback) (int, error) {
	targetUint, ok := toUint64(target)
	if !ok {
		return 0, fmt.Errorf("type mismatch: expected uint64 for column")
	}
...
func (cs *ColumnScanner) streamScanFloat64LessThan(col *blockpack.Column, target any, callback vm.RowCallback) (int, error) {
	targetFloat, ok := toFloat64(target)
	if !ok {
		return 0, fmt.Errorf("type mismatch: expected float64 for column")
	}
...
func (cs *ColumnScanner) streamScanBytesLessThan(col *blockpack.Column, target any, callback vm.RowCallback) (int, error) {
	count := 0
	for i := 0; i < cs.block.SpanCount(); i++ {
		val, ok := col.BytesValueView(i)
		if !ok {
...
func (cs *ColumnScanner) streamScanStringLessThanOrEqual(col *blockpack.Column, target any, callback vm.RowCallback) (int, error) {
	// Handle numeric target (string to number comparison)
	if targetNumeric, ok := numericTarget(target); ok {
		count := 0
		for i := 0; i < cs.block.SpanCount(); i++ {
...
func (cs *ColumnScanner) streamScanInt64LessThanOrEqual(col *blockpack.Column, target any, callback vm.RowCallback) (int, error) {
	targetInt, ok := toInt64(target)
	if !ok {
		return 0, fmt.Errorf("type mismatch: expected int64 for column")
	}
...
func (cs *ColumnScanner) streamScanUint64LessThanOrEqual(col *blockpack.Column, target any, callback vm.RowCallback) (int, error) {
	targetUint, ok := toUint64(target)
	if !ok {
		return 0, fmt.Errorf("type mismatch: expected uint64 for column")
	}
...
func (cs *ColumnScanner) streamScanFloat64LessThanOrEqual(col *blockpack.Column, target any, callback vm.RowCallback) (int, error) {
	targetFloat, ok := toFloat64(target)
	if !ok {
		return 0, fmt.Errorf("type mismatch: expected float64 for column")
	}
...
func (cs *ColumnScanner) streamScanBytesLessThanOrEqual(col *blockpack.Column, target any, callback vm.RowCallback) (int, error) {
	count := 0
	for i := 0; i < cs.block.SpanCount(); i++ {
		val, ok := col.BytesValueView(i)
		if !ok {
...
// StreamScanLessThanOrEqual scans for rows where column <= value
func (cs *ColumnScanner) StreamScanLessThanOrEqual(columnName string, target any, callback vm.RowCallback) (int, error) {
	col := cs.block.GetColumn(columnName)
	if col == nil {
		return 0, nil
	}
...
func (cs *ColumnScanner) streamScanStringGreaterThan(col *blockpack.Column, target any, callback vm.RowCallback) (int, error) {
	// Handle numeric target (string to number comparison)
	if targetNumeric, ok := numericTarget(target); ok {
		count := 0
		for i := 0; i < cs.block.SpanCount(); i++ {
...
func (cs *ColumnScanner) streamScanInt64GreaterThan(col *blockpack.Column, target any, callback vm.RowCallback) (int, error) {
	targetInt, ok := toInt64(target)
	if !ok {
		return 0, fmt.Errorf("type mismatch: expected int64 for column")
	}
...
func (cs *ColumnScanner) streamScanUint64GreaterThan(col *blockpack.Column, target any, callback vm.RowCallback) (int, error) {
	targetUint, ok := toUint64(target)
	if !ok {
		return 0, fmt.Errorf("type mismatch: expected uint64 for column")
	}
...
func (cs *ColumnScanner) streamScanFloat64GreaterThan(col *blockpack.Column, target any, callback vm.RowCallback) (int, error) {
	targetFloat, ok := toFloat64(target)
	if !ok {
		return 0, fmt.Errorf("type mismatch: expected float64 for column")
	}
...
func (cs *ColumnScanner) streamScanBytesGreaterThan(col *blockpack.Column, target any, callback vm.RowCallback) (int, error) {
	count := 0
	for i := 0; i < cs.block.SpanCount(); i++ {
		val, ok := col.BytesValueView(i)
		if !ok {
...
func (cs *ColumnScanner) streamScanStringGreaterThanOrEqual(col *blockpack.Column, target any, callback vm.RowCallback) (int, error) {
	// Handle numeric target (string to number comparison)
	if targetNumeric, ok := numericTarget(target); ok {
		count := 0
		for i := 0; i < cs.block.SpanCount(); i++ {
...
func (cs *ColumnScanner) streamScanInt64GreaterThanOrEqual(col *blockpack.Column, target any, callback vm.RowCallback) (int, error) {
	targetInt, ok := toInt64(target)
	if !ok {
		return 0, fmt.Errorf("type mismatch: expected int64 for column")
	}
...
func (cs *ColumnScanner) streamScanUint64GreaterThanOrEqual(col *blockpack.Column, target any, callback vm.RowCallback) (int, error) {
	targetUint, ok := toUint64(target)
	if !ok {
		return 0, fmt.Errorf("type mismatch: expected uint64 for column")
	}
...
func (cs *ColumnScanner) streamScanFloat64GreaterThanOrEqual(col *blockpack.Column, target any, callback vm.RowCallback) (int, error) {
	targetFloat, ok := toFloat64(target)
	if !ok {
		return 0, fmt.Errorf("type mismatch: expected float64 for column")
	}
...
func (cs *ColumnScanner) streamScanBytesGreaterThanOrEqual(col *blockpack.Column, target any, callback vm.RowCallback) (int, error) {
	count := 0
	for i := 0; i < cs.block.SpanCount(); i++ {
		val, ok := col.BytesValueView(i)
		if !ok {
...
// StreamScanGreaterThanOrEqual scans for rows where column >= value
func (cs *ColumnScanner) StreamScanGreaterThanOrEqual(columnName string, target any, callback vm.RowCallback) (int, error) {
...
func (cs *ColumnScanner) StreamScanRegexNotMatch(columnName string, pattern string, callback vm.RowCallback) (int, error) {
	col := cs.block.GetColumn(columnName)
	if col == nil {
		return 0, nil
	}
