...
func NewTrackingReaderProvider(underlying ReaderProvider) (*TrackingReaderProvider, error) {
	if underlying == nil {
...
func NewTrackingReaderProviderWithLatency(
	underlying ReaderProvider,
	latency time.Duration,
) (*TrackingReaderProvider, error) {
	if underlying == nil {
		return nil, fmt.Errorf("underlying provider cannot be nil")
	}
	return &TrackingReaderProvider{
...
// ReadAt reads bytes from the underlying data source at the specified offset.
