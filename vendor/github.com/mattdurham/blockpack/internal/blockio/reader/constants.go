...
const (
	...
	presenceRLEVersion    = shared.PresenceRLEVersion
...
// This is now the only footer format used for all files
const footerSize = 2 + 8 // version(2) + header_offset(8)

const (
	defaultBlockTargetBytes = 512 * 1024
	// DefaultBlockTargetBytes is the default target size for blocks in bytes.
